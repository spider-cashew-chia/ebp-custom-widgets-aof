            ...
            <svg class="ebp-header-1-home-bg-svg" viewBox="0 0 1000 1000" preserveAspectRatio="xMidYMid slice"
                ...
                <defs>
                    <mask id="<?php echo esc_attr($home_mask_id); ?>" maskUnits="userSpaceOnUse" x="0" y="0"
                        ...
                        <!-- Circle = black (hide video); letters = white (show video). White circle is drawn as overlay below. -->
                        <g class="ebp-header-1-home-mask-logo">
                            <path id="<?php echo esc_attr($home_mask_id); ?>-solid" class="ebp-home-mask-solid"
                                fill="#000"
                ...
                <!-- Solid white circle overlay: same transform as mask logo so it stays aligned and zooms with the reveal -->
                <g class="ebp-header-1-home-mask-logo ebp-header-1-home-white-circle" aria-hidden="true">
                    <use href="#<?php echo esc_attr($home_mask_id); ?>-solid" fill="#fff" />
                </g>
            </svg>
        </div>
        <?php endif; ?>
